<script>
  ...
  import { mdiBookOutline, mdiAccountGroupOutline } from '@mdi/js'
...
<div class="h-screen w-screen px-4 sm:px-10 py-10 bg-gray-100">
  ...
  <div class="mt-6 text-xl font-bold text-gray-700 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 select-none">
    ...
    <div class="rounded p-4 m-4 transition-all shadow hover:shadow-md cursor-pointer flex items-center bg-white" on:click={() => goto('/group')}>
